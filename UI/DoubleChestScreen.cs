// Screen for the double chest inventory (6 rows x 9 = 54 slots) | DA | 3/8/26
...
public class DoubleChestScreen : InventoryScreenBase
{
    ...
    protected override WindowKind Kind => WindowKind.DoubleChest;

    protected override ItemStack? LocalContainerSlot(int index) => mChest.GetSlot(index);

    public DoubleChestScreen(BlockIconRenderer iconRenderer, Texture itemTexture)
        : base(iconRenderer, itemTexture)
    {
    }

    public void SetChest(DoubleChestData chest) => mChest = chest;
    ...
    public void Render()
    {
        ...
        // In multiplayer there is no local DoubleChestData - the snapshot is the chest.
