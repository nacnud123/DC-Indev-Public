...
public class WorldSaveData
{
    ...
    // WorldSize/WorldType used to live here. Worlds are infinite now, so there's no grid dimension
    // to record, and the shape presets only ever fed the retired fixed-area generator. XmlSerializer
    // ignores the leftover elements in older saves.
