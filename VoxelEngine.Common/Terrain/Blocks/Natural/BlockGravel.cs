...
public class BlockGravel : Block
{
    ...
    public override ItemStack? GetDrop(byte metadata) => GameContext.Current.GameRandom.NextSingle() < 0.1f ? ItemStack.FromItem(ItemType.Flint) : ItemStack.FromBlock(BlockType.Gravel);
}
