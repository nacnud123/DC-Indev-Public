...
public abstract class Block
{
    ...
    /// <summary>
    /// How little this block's surface grips: entities standing on it keep this fraction of their
    /// horizontal momentum each tick (before the global 0.91 air factor). 0.6 is normal ground;
    /// ice is 0.98 in vanilla, which is the whole of why ice slides.
    /// </summary>
    public virtual float Slipperiness => 0.6f;
...

    {
        ...
        var tnt = new TntEntity(new Vector3(x, y, z), this, fuseDuration, explosionRadius, explosionPower);
        world.AddEntity(tnt);
    }
}
