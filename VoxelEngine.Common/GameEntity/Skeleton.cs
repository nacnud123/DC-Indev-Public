...
public class Skeleton : Entity
{
    ...
    private readonly IRenderHandle? mLegArmModel; // shared mesh used for both legs and both arms
    ...
    public Skeleton(Vector3 position)
    {
        ...
        mLegArmModel = RenderBackend.Current.LoadModel(LEGARM_MODEL, LEGARM_TEXTURE);
    ...
    public override void TakeDamage(int amount)
    {
        ...
        if (!IsAlive)
        {
            ...
            int count = GameContext.Current.GameRandom.Next(0, 6);
            if (count > 0)
            {
