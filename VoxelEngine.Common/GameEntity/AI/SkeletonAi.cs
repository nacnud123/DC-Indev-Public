...
public class SkeletonAi : HostileEntityAi
{
    ...
    protected override void OnAttackEntity(World world, float dist)
    {
        ...
        var target = World.NearestPlayerTo(mSkeleton.Position);
        if (target == null)
            return;
        ...
        GameContext.Current.AudioManager.PlayAudio("Resources/Audio/Bow/BowRelease.ogg", GameContext.Current.AudioManager.SfxVol);
