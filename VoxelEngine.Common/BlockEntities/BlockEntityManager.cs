...
public static class BlockEntityManager
{
    ...
    /// <summary>Every registered furnace, for the server's per-tick sweep.</summary>
    public static IEnumerable<FurnaceData> Furnaces => BlockEntities.Values.OfType<FurnaceData>();
