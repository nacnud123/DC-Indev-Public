...
/// Spawn counts are capped relative to world size so mob density scales with world footprint
...
public class MobSpawner
{
    ...
    // Checks a block coordinate is within the world's horizontal chunk grid and within the
    // vertical band that's valid for a mob to stand in (excludes the very bottom/top rows
    // so both the mob's feet and a block above it are always addressable).
